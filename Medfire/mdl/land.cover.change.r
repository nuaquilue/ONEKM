...
land.cover.change <- function(land, coord, interface, lc.trans=1, t, visit.cells){
  ...
  lsprd <- pattern.lchg[lc.trans,3]
  k <- pattern.lchg[lc.trans,4]
